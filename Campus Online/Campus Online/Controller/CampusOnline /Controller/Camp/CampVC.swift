...
class CampVC: UIViewController, ShowAllCampingData {
    func onClickListener(for cell: CampingDataView) {
        
    }
    
    
    var topic : String =  "camping"
...
extension CampVC : UICollectionViewDelegate , UICollectionViewDelegateFlowLayout , UICollectionViewDataSource{
...
extension CampVC : CampingVCDataDelegate {
...
extension CampVC : CampingVCDelegate{
