...
class SetNewCampingPost: UIViewController , LightboxControllerDismissalDelegate, GalleryControllerDelegate {
    ...
    lazy var dataModel = [CampingModel]()
    ...
    fileprivate func configureCollectionView() {
        ...
        collectionview.register(CampingCell.self, forCellWithReuseIdentifier: imageCell)
                ...
                image.resolve {[weak self] (img) in
                    ...
                    if let img_data = img!.jpegData(compressionQuality: 0.8){
                        if sself.checkDataModelHasValue(data:  img_data){
                            ...
                            sself.dataModel.append(CampingModel.init(postDate: sself.postDate, currentUser: sself.currentUser, type: DataTypes.image.description, data: img_data))
...
extension SetNewCampingPost :  UICollectionViewDataSource, UICollectionViewDelegateFlowLayout{
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return data.count
    }
    
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionview.dequeueReusableCell(withReuseIdentifier: imageCell, for: indexPath) as! CampingCell
...
extension SetNewCampingPost : UITextViewDelegate {
...
//MARK:-DeleteImageCampingCell
extension SetNewCampingPost : DeleteImageCampingCell {
