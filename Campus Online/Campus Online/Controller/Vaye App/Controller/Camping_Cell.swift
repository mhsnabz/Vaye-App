...
class Camping_Cell: UICollectionViewCell, ShowAllCampingData {
   ...
   weak var rootController : VayeApp?
    ...
    fileprivate func configureUI(){
        ...
        collectionview.register(CampingView.self, forCellWithReuseIdentifier: cellID)
        collectionview.register(CampingDataView.self , forCellWithReuseIdentifier: cellData)
                            ...
                            if err == nil {
                                ...
                                if snap.exists
                                {
                                    ...
                                    let deleteDb = Firestore.firestore().collection(currentUser.short_school)
                                        .document("main-post")
                                        .collection("camping").document(postId.documentID)
                                    deleteDb.delete()
...
//                loadMore = false
    ...
    func fetchAds() {
        adLoader = GADAdLoader(adUnitID: adUnitID, rootViewController: rootController, adTypes: [ .unifiedNative ], options: nil)
...
extension Camping_Cell : UICollectionViewDelegate , UICollectionViewDelegateFlowLayout , UICollectionViewDataSource{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if mainPost[indexPath.row].data.isEmpty {
                ...
                let cell = collectionview.dequeueReusableCell(withReuseIdentifier: cellID, for: indexPath) as! CampingView
                cell.delegate = self
            ...
            let cell = collectionview.dequeueReusableCell(withReuseIdentifier: cellData, for: indexPath) as! CampingDataView
...
//MARK: - google ads
extension Camping_Cell :  GADUnifiedNativeAdLoaderDelegate, GADAdLoaderDelegate , GADUnifiedNativeAdDelegate  {
...
extension Camping_Cell : ASMainOtherUserDelegate {
...
extension Camping_Cell : ASMainPostLaungerDelgate {
...
extension Camping_Cell : CampingVCDataDelegate {
...
extension Camping_Cell : CampingVCDelegate{
