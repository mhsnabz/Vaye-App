...
class MainTabbar: UITabBarController,UITabBarControllerDelegate  {
    ...
    func configureViewControler(user : CurrentUser){
        ...
        let vaye_app = setNavigationController(title: "Online Kampüs",unselectedImage: UIImage(named: "c-unselected")!, selectedImage: UIImage(named: "c-unselected")!,rootViewController: VayeApp(currentUser: user))
