...
//        menuBar.profileModel = ProfileModel(shortSchool: currentUser.short_school, currentUser: currentUser, major: currentUser.bolum, uid: currentUser.uid)
    ...
    init(currentUser : CurrentUser , width : CGFloat ) {
...
extension ProfileVC : UICollectionViewDataSource, UICollectionViewDelegateFlowLayout{
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        if isHomePost{
            ...
            let vc = MajorPostCommentController(currentUser: currentUser, postId: favPost[indexPath.row].postId, lessonPost: favPost[indexPath.row], noticesPost: nil, mainPost: nil)
            self.navigationController?.pushViewController(vc, animated: true)
        }else if isSchoolPost{
            let vc = MajorPostCommentController(currentUser: currentUser, postId: schoolPost[indexPath.row].postId, lessonPost: nil, noticesPost: schoolPost[indexPath.row], mainPost: nil)
...
extension ProfileVC : BuySellVCDelegate {
...
extension ProfileVC : NewPostNoticesDataVCDelegate {
...
extension ProfileVC : BuySellVCDataDelegate {
...
extension ProfileVC : FoodMeVCDelegate {
...
extension ProfileVC : FoodMeVCDataDelegate {
...
extension ProfileVC : CampingVCDelegate {
...
extension ProfileVC : CampingVCDataDelegate {
