//
//  ASNoticesPostCurrentUserLaunher.swift
//  Campus Online
//
...
class ASNoticesPostCurrentUserLaunher : NSObject {
    ...
    func show(post : NoticesMainModel){
        self.post = post
...
extension ASNoticesPostCurrentUserLaunher : UITableViewDelegate , UITableViewDataSource{
