...
import UIKit
class NotificationLaunher: NSObject {
    ...
    weak var delegate : NotificationLauncherDelegate?
    private lazy var viewModel = ActionSheetNotification(currentUser: currentUser, target: target)
    ...
    func configureTableView()
    {
        ...
        tableView.register(ActionSheetCell.self, forCellReuseIdentifier: "id")
...
extension NotificationLaunher : UITableViewDataSource,UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.notificationOption = viewModel.imageOptions[indexPath.row]
        return cell
    }
